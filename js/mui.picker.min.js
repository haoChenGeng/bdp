	...
	e.DtPicker = e.Class.extend({
		...
		setSelectedValue: function(e) {
			var t = this,
				i = t.ui,
				a = t._parseValue(e);
			i.y.picker.setSelectedValue(a.y, 0), i.m.picker.setSelectedValue(a.m, 0), i.d.picker.setSelectedValue(a.d - 1, 0), i.h.picker.setSelectedValue(a.h, 0), i.i.picker.setSelectedValue(a.i, 0)
		},
